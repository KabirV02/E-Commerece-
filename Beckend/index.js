...
//Creating API for deleteion Product
...
// Creating End-Point for register user

app.post('/signup',async(req,res)=>{
    let check = await Users.findOne({email:req.body.email})
    if(check){
        return res.status(400).json({success:false,errors:"Existing user find with same email address"})
    }
    let cart = {}
    for(let i =0;i<300;i++){
        cart[i] = 0
...
// Creating endpoint product from cart data
...
// Creating cart data save after login
